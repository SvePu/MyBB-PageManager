...
$l['pagemanager_main_table_devices']='Visible on Devices';
...
$l['pagemanager_edit_form_deviceselect']='Show page on devices';
$l['pagemanager_edit_form_deviceselect_description']='Select the devices type where this page should be visible.';
$l['pagemanager_edit_form_deviceselect_all']='All Devices';
$l['pagemanager_edit_form_deviceselect_desktop']='Desktop PCs';
$l['pagemanager_edit_form_deviceselect_mobile']='Mobile Phones & Tablets';
